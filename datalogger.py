...
import signal
import threading
from NANO_module.data_collection.lib.config_parameters import *
from NANO_module.data_collection.lib.utils import *
from NANO_module.data_collection.lib import Imu
from NANO_module.data_collection.lib.Gps import *
from NANO_module.data_collection.lib.lidar_sensor import *

       
################################################## SENSOR FUNCTIONS #################################################
def save_lidar_data(lidar_d):
    global data_root, dict_frame, configuration, sensor_frame,scene_count, car_location
...
def save_image_data():
    global data_root, dict_frame, configuration, sensor_frame,scene_count, vid,  car_location
